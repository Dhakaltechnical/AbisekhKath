...
const {addProduct,getAllProducts,updateProduct, removeProduct,addProductReview,getReviews,deleteReviews} = require("../controller/productController");
...
router.route("/review/delete/:id").delete(isAuthenticated,deleteReviews);
